...
<head>
    ...
    <title>Pharmacy Council::Contact information</title>
    ...
    <div class="row">
		...
		<div class="pull-right"> Welcome : {{ Auth::user()->cnic }}
            ...
            <div class="pull-left">
				...
				<h2 class="pull-right"> Applicant's Contact information</h2> <br/>
            ...
            <div class="pull-right">
                ...
                <a class="btn btn-success" href="{{ route('contact_information.index') }}">  Contact Information</a>
                <a class="btn btn-secondary" href="{{ route('qualification_information.index') }}">  Qualification information</a>
				 <a class="btn btn-secondary" href="{{ route('experience_information.index') }}">  Experience information</a>
