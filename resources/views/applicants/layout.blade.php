...
<head>
    ...
    <title>Pharmacy Council::Personal information</title>
  ...
  <!-- Settings Dropdown -->
		...
		<div class="pull-right"> Welcome : {{ Auth::user()->cnic }}
            ...
            <div class="pull-left"> 
				...
				<h2 class="pull-right"> Applicant's Personal information</h2> <br/>
            ...
            <div class="pull-right">
                ...
                <a class="btn btn-success" href="{{ route('applicants.index') }}">  Personal Information</a>
