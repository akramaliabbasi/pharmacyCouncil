...
@section('content')
 ...
 <div class="pull-left">
                 <a class="btn btn-info" href="{{ route('experience_information.create') }}">Add New</a>
            </div>
    ...
    <table class="table table-bordered">
        ...
        @foreach ($experience_information as $qualificationinformation)
        ...
        <tr>
            ...
            <td>
                ...
                <form action="{{ route('experience_information.destroy',$qualificationinformation->id) }}" method="POST">

   

              
                   
                    <a class="btn btn-info" href="{{ route('experience_information.show',$qualificationinformation->id) }}">Show</a>
                    <a class="btn btn-primary" href="{{ route('experience_information.edit', $qualificationinformation->id) }}">Edit</a>
